...
<Image src={build1Img} alt="image of build prosess" />
...
<Image src={build1_5Img} alt="image of build prosess" />
...
<Image src={build2Img} alt="image of build prosess" />
...
<Image src={build3Img} alt="image of build prosess" />
...
Obviously this did not work. The lithium-ion battery rested way too high and wouldn't you know it, my car had the beefiest of beefy dynamoes capable of producing way over 200Amps, way over the relay specifications. However I winged it and did some napkin math. As long as i never charged the battery from near or completely flat it should be fine. I really did not have the time to work it out exactly now, and I installed a large AMP-meter to give indication of how much it charged, as well as a 200AMP-fuse. One would almost be forgiven for thinking it would work.
